...
import logoBizum from '../img/Bizum_idSDhC8lZu_1.png'

const Checkout = () => {
    //Se usa el contexto de usuario 
        ...
        <div className="container-checkout">
            ...
            <div className="checkout-message-payment-logos">
                ...
                <div className="container-icons-checkout">
                    <div className="container-icon-masterCard">
                    ...
                    <div className="container-icon-visa">
                        <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
                    ...
                    <div className="container-icon-paypal">
                    ...
                    <div className="container-icon-bizum">
                        <img src={logoBizum} alt="bizum-logo" />
                    </div>
                    
                </div>

                <p className="p-button"><Link to="/cart">Back to Card</Link></p>

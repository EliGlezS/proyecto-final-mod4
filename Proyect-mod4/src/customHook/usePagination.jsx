...
const usePagination = (itemsXPage, items) => {
    ...
    //Se calcula el indice inicial y dinal para los productos que deben mostrarse en esa pág
    const indexLastItem = currentPage * itemsXPage;
    const inexFirstItem = indexLastItem - itemsXPage;
